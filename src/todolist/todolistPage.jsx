...
export default function TodoList() {
    ...
    return items.map((item, k) => {
      return (
        <li
          className={
            isCompleted[k]
              ? "  mb-2 bg-gray-200 border-1 flex justify-between p-3 border"
              : "mb-2 bg-gray-100 border-1 flex justify-between p-3 "
          }
          key={k}
        >
          <div
            className={
              isCompleted[k]
                ? " lg:w-7/12 xl:w-7/12 md:w-7/12 w-8/12  text-black font-bold overflow-auto line-through opacity-25	"
                : " lg:w-7/12 xl:w-7/12 md:w-7/12 w-8/12  text-black font-bold overflow-auto	"
            }
          >
            {" "}
            {item}{" "}
          ...
          <div className="flex justify-end lg:w-5/12 xl:w-5/12 md:w-5/12 w-3/12  ">
            <span
              className={
                isCompleted[k]
                  ? "text-gray-400 font-lighter p-2 mr-4 border-b lg:flex xl:flex md:flex hidden opacity-30	 "
                  : "text-gray-400 font-lighter p-2 mr-4 border-b lg:flex xl:flex md:flex hidden "
              }
            >
              {" "}
              {currentDate[k]}{" "}
            ...
            {isCompleted[k] ? (
              <button
                className="border-b p-2 text-white font-bold"
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="w-6 h-6 text-red-500 hover:text-red-400 hover:translate-y-0.5 transform transition-all duration-300"
                >
                  <path
              ...
              <button
                className="border-b lg:ml-4 xl:ml-4 md:ml-4 ml-0 p-2 text-white font-bold"
              ...
              >
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  className="w-6 h-6 text-green-500 hover:text-green-400 hover:translate-y-0.5 transform transition-all duration-300"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <button className="border-b lg:ml-4 xl:ml-4 md:ml-4 ml-0 p-2 text-white font-bold">
              <input
                onChange={() => handleCompleted(k)}
                type="checkbox"
                className="h-5 w-5"
                checked={isCompleted[k]}
              />
            </button>
          </div>
        </li>
  ...
  if (newuser === "") {
    return (
      <>
        <div className="absolute left-3 top-3">
          <button
            onClick={toggleNotifucation}
            className="  bg-yellow-400 p-2 font-bold rounded-md hover:bg-yellow-500 hover:translate-y-0.5 transform transition-all duration-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        {isToglle ? (
          <div className=" bg-white p-4 text-center xl:w-full lg:w-full flex items-center justify-center">
            <input
              className=" border-2 p-2 mr-2 xl:w-4/12 lg:w-4/12 outline-yellow-300 md:w-4/12 rounded-md w-5/12 -tracking-tight"
              type="text"
              ref={userName}
              placeholder="username..."
            />
            <button
              className="py-2 px-4 bg-yellow-400 rounded font-bold tracking-widest text-yellow-700 hover:bg-yellow-500 hover:translate-y-0.5 transform transition-all duration-300 hover:text-yellow-700"
              onClick={AddUser}
              type="submit"
            >
              {" "}
        ...
        <section className=" bg-white flex flex-col items-center w-full overflow-auto pb-4">
          <div className="  flex justify-center lg:w-5/12 md:w-10/12 sm:w-10/12 p-5 text-3xl text-center lg:mt-2 xl:mt-2 md:mt mt-16 mb-5 ">
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 text-black mt-2 ml-2"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="lg:w-10/12 xl:w-10/12 md:w-10/12 w-10/12 bg-gray-300 p-5">
            <div className="w-9/12 flex justify-evenly m-auto">
              <input
                placeholder="Typing..."
                className="border outline-blue-200 rounded p-2 lg:w-9/12 xl:9/12 md:9/12 w-8/12 "
                ref={text}
                type="text"
              />
              <button
                className={
                  isUpdating
                    ? "bg-green-300 text-green-600 rounded p-2 lg:w-2/12 xl:2/12 md:2/12 w-3/12 font-bold hover:bg-green-400 hover:translate-y-0.5 transform transition-all duration-300"
                    : "bg-yellow-300 text-yellow-600 rounded p-2 lg:w-2/12 xl:2/12 md:2/12 w-3/12 font-bold hover:bg-yellow-400 hover:translate-y-0.5 transform transition-all duration-300"
                }
                onClick={handleADD}
              >
            ...
            <div className=" mt-4 xl:w-10/12 lg:w-10/12 md:w-10/12 w-full overflow-auto  m-auto p-4 ">
              <ul>
                {items.length > 0 ? (
                  displaylist()
                ) : (
                  <li className="text-gray-600 border-2 p-4">No Items</li>
                )}
              </ul>
            </div>
          </div>
    ...
    return (
      <>
        <section className="flex bg-slate-100 flex-col items-center overflow-auto pb-4">
          <div className="  flex items-center  p-2 text-2xl text-yellow-200 absolute left-3 top-3  px-6 bg-gray-100 shadow rounded-md hover:translate-y-0.5 transform transition-all duration-300 ">
            <h2 className="font-lighter text-yellow-600">
              {" "}
              welcome <span className="font-bold">{newuser}</span>{" "}
            </h2>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-6 h-6 text-yellow-600  lg:mt-1 ml-2 "
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-7 h-7 border-l cursor-pointer border-gray-500  ml-4 px-1 text-red-500 hover:text-red-400 hover:translate-y-0.5 transform transition-all duration-300"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="lg:w-10/12 xl:w-10/12 md:w-10/12 w-10/12 bg-gray-300 p-5">
            <div className="w-9/12 flex justify-evenly m-auto">
              <input
                placeholder="Typing..."
                className="border outline-yellow-200 rounded p-2 lg:w-9/12 xl:9/12 md:9/12 w-8/12 "
                ref={text}
                type="text"
              />
              <button
            ...
            <div className=" mt-4 xl:w-10/12 lg:w-10/12 md:w-10/12 w-full  h-auto overflow-auto m-auto p-4 ">
              <ul>
                {items.length > 0 ? (
                  displaylist()
                ) : (
