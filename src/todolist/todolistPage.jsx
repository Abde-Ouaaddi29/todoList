      ...
      return (
        ...
        <li className="mb-2 bg-gray-100 border-1 flex justify-between p-3  " key={k}>
          ...
          <span className="text-gray-400 font-lighter p-2 mr-4 border-b "> {currentDate[k]} </span>
            ...
            <button className="border-b ml-4 p-2 text-white font-bold" onClick={() => handleUpdate(k)}>
  ...
  if (newuser === '') {
      ...
      {isToglle ? 
          <div className="mt-4 text-center xl:w-full lg:w-full "> 
            <input className="p-2 mr-2 xl:w-4/12 lg:w-4/12 rounded-md sm:w-1/12" type="text" ref={userName} placeholder="username" />
      ...
      <div className=" flex justify-center lg:w-5/12 md:w-10/12 sm:w-10/12 p-5 text-3xl text-center mt-6 mb-5">
      ...
      <div className="lg:w-10/12 xl:w-10/12 md:w-12/12 sm:w-12/12 bg-gray-300 p-5">
        <div className="w-9/12 flex justify-evenly m-auto">
          <input className="border p-2 lg:w-9/12 sm:w-6/12 " ref={text} type="text"/>
          <button className="bg-blue-300 text-white lg:p-2 sm:p-2 w-2/12 font-bold hover:bg-blue-400 hover:translate-y-0.5 transform transition-all duration-300" onClick={handleADD}>
            ADD
          </button>
        </div>

        <div className=" mt-4 xl:w-10/12 lg:w-10/12 sm:w-full  m-auto p-4 ">
        ...
        <section className="flex flex-col items-center w-full">
          ...
          <div className="w-10/12 bg-gray-300 p-5">
            <div className="w-10/12 flex justify-evenly m-auto">
              ...
              <button className="bg-blue-300 text-white p-2 w-2/12 font-bold hover:bg-blue-400 hover:text-gray-300 rounded-md hover:translate-y-0.5 transform transition-all duration-300" onClick={handleADD}>
                ADD
              </button>      
            </div>
  
            <div className=" mt-4 w-10/12 m-auto p-4 ">
              <ul>{items.length > 0 ? displaylist() : <li className="text-gray-600 border-2 p-4 w-12/12 ">No items</li>}</ul>
            </div>
          </div>
        </section>
      </>
